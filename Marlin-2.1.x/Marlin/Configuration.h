...
#define STRING_CONFIG_H_AUTHOR "(Christopher Ta, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Digital_Ender"
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // Leave commented for BigTreeTech Board
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.3, -4.77, 0 }
